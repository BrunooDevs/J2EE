<%-- 
    Document   : DoctoresServicio
    Created on : 31 oct 2022, 17:38:28
    Author     : Owner
--%>
...
<html lang="en">
    ...
    <main>
        ...
        <div class="container px-4 py-5" id="featured-3">
            ...
            <h2 class="pb-2 border-bottom pt-5">Doctores Disponibles</h2>
            ...
            <%
                ...
                try {
                    ...
                    java.util.List<java.lang.String> especialidades = port.especialidades();
                     java.util.List<java.lang.String> correos = port.correos();
                      java.util.List<java.lang.String> telefonos = port.telefonos();

                    out.println("<div class=\"row g-5 py-5 row-cols-1 row-cols-lg-3\">    ");
                    for (int i = 0; i < result.size(); i++) {

                        out.println("<div class=\"feature col\"> ");
                        out.println("<div class=\"feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3\">  ");
                        out.println(" <svg class=\"bi\" width=\"1em\" height=\"1em\" ><use xlink:href=\"#people-circle\"/></svg>  ");
                        out.println("</div>");

                        out.println("<h3 class=\"fs-2\"> " + result.get(i) + "</h3>");
                        out.println("<p>" + "Correo: " +  correos.get(i) + "</p>");
                        out.println("<p>" + "Telefono: " +  telefonos.get(i) + "</p>");

                        out.println("<a href=\"\" class=\"icon-link d-inline-flex align-items-center\">");
                        out.println(especialidades.get(i));
                        out.println("<svg class=\"bi\" width=\"1em\" height=\"1em\"><use xlink:href=\"#chevron-right\"/></svg>");
                        out.println("</a>");
